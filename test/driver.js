var objj_transpiler = require("../dist/objj-transpiler.cjs")
...
exports.runTests = function(config, callback) {
  ...
  for (var i = 0; i < tests.length; ++i) {
    ...
    try {
      var code = objj_transpiler.compile(test.code, null, {acornOptions: testOpts}).code()
      if (expected.onToken = testOpts.onToken) testOpts.onToken = [];
      let savePreInclude = testOpts.preIncludeFiles
      delete testOpts.preIncludeFiles
      var ast = parse(code, testOpts)
      testOpts.preIncludeFiles = savePreInclude
    } catch(e) {
...
var misMatch = exports.misMatch = function(exp, act) {
  if (!exp || !act || (typeof exp !== "object") || (typeof act !== "object")) {
    ...
    for (var prop in exp) {
      if (prop == "start" || prop == "end" || prop == "loc" || prop == "range") continue;
